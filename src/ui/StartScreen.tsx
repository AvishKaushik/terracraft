  ...
  return (
    <div id="start-screen" className={started ? 'hidden' : ''}>
      ...
      <div className="controls">
        ...
        <div className="row"><span className="label">Select block</span><span><kbd>1</kbd> – <kbd>9</kbd> or <kbd>Scroll</kbd></span></div>
        <div className="row"><span className="label">Fly toggle</span><span>double-tap <kbd>Space</kbd> · ascend <kbd>Space</kbd> · descend <kbd>Ctrl</kbd></span></div>
      ...
      <button id="start-button" onClick={handlePlay}>Click to Play</button>
    </div>
  );
}
